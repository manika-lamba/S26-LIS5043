...
From this metadata, online or information systems infer attributes about us, such as gender, ethnicity, class, age, education level, or even whether we are likely to be a parent. These inferences are not things we explicitly declare; they are derived from what’s often called our digital trace, digital footprint, or digital breadcrumbs.
...
::: notes
On this slide, you will see examples of metadata from real-world sources like books, Word files, blogs, emails, and webpages. When you view the HTML version of the slides, take a moment to look at each example and check whether you would have recognized the metadata on your own.
:::
